        ...
        <div className="px-4 sm:px-6 lg:px-8 mt-20">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                <div className="stat text-center">
                    <div className="stat-title text-lg text-slate-700 font-bold">Total Tutors</div>
                    <div className="stat-value text-base sm:text-4xl font-semibold">{tutorsCount}</div>
                    <div className="stat-desc text-sm text-gray-500">Experienced tutors</div>
                </div>
                <div className="stat text-center">
                    <div className="stat-title text-lg font-bold text-slate-700">Total Reviews</div>
                    <div className="stat-value text-base sm:text-4xl font-semibold">{reviewCount}</div>
                    <div className="stat-desc text-sm text-gray-500">Praised tutors review</div>
                </div>
                <div className="stat text-center">
                    <div className="stat-title text-lg font-bold text-slate-700">Total Languages</div>
                    <div className="stat-value text-base sm:text-4xl font-semibold">{languagesCount}</div>
                    <div className="stat-desc text-sm text-gray-500">Max languages of the world</div>
                </div>
                <div className="stat text-center">
                    <div className="stat-title text-lg font-bold text-slate-700">Total Users</div>
                    <div className="stat-value text-base sm:text-4xl font-bold">{usersCount}</div>
