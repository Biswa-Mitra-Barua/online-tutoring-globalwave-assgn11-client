        ...
        <div className="px-4 sm:px-6 lg:px-8 py-10">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                <div className="stat text-center">
                    ...
                    <div className="stat-value text-3xl sm:text-4xl font-bold">9,400</div>
                ...
                <div className="stat text-center">
                    ...
                    <div className="stat-value text-3xl sm:text-4xl font-bold">89,400</div>
                ...
                <div className="stat text-center">
                    ...
                    <div className="stat-value text-3xl sm:text-4xl font-bold">120</div>
                ...
                <div className="stat text-center">
                    ...
                    <div className="stat-value text-3xl sm:text-4xl font-bold">65,400</div>
